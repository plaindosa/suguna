          ...
          {[
            ...
            <div key={i} className="group relative overflow-hidden rounded-2xl bg-zinc-100 border border-zinc-200 shadow-sm transition-all hover:shadow-xl select-none">
              <div className="aspect-[4/3] w-full overflow-hidden relative">
                ...
                {/* Hover Content */}
                <div className="absolute inset-x-0 bottom-0 z-40 p-4 sm:p-5 translate-y-0 md:translate-y-4 md:group-hover:translate-y-0 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end pointer-events-none">
